                            ...
                            <aside class="col-sm-5">
                                <article class="p-5">
                                    ...
                                    <form action="{{ route('product.add.cart') }}" method="POST" role="form" id="addToCart">
                                        ...
                                        <hr>
                                        <div>
                                        <button type="submit" class="btn btn-success"><i class="fas fa-shopping-cart"></i> Add To Cart </button> <a href="{{ route('checkout.cart') }}" class="btn btn-primary"><i class="fas fa-shopping-cart"></i> Voire panier</a></div>
                                    </form>
                                    <div class="rating-wrap" style="margin-top: 20px;">
